...
/***/ function(module, exports, __webpack_require__) {
	...
	var mixinObject = {
	  ...
	  _alertMessage: function _alertMessage(msg) {
	    alert(msg);
	  }
	};
	...
	var InputButton = function (_Component) {
	  ...
	  function InputButton() {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(InputButton).call(this));

	    _this.state = {
	      val: ''
	    };
	    _reactMixin2.default.onClass(InputButton, mixinObject);
	    return _this;
	  }
	...
	_reactDom2.default.render(_react2.default.createElement(InputButton, null), document.getElementById('demo5'));

	InputButton.propTypes = { initialCount: _react2.default.PropTypes.number };
