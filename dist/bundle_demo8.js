...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lifecycleWatcher = __webpack_require__(169);

	var _lifecycleWatcher2 = _interopRequireDefault(_lifecycleWatcher);

	var _simpleComponent = __webpack_require__(170);

	var _simpleComponent2 = _interopRequireDefault(_simpleComponent);

	var _complicatedComponent = __webpack_require__(171);

	var _complicatedComponent2 = _interopRequireDefault(_complicatedComponent);
	...
	var BookListContainer = _react2.default.createClass({
	  ...
	  mixins: [_lifecycleWatcher2.default],
	...
	//  <SimpleComponent />,
	_react2.default.createElement(_complicatedComponent2.default, null), document.getElementById('demo8'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LifecycleWatcher = {
	  _printMessage: function _printMessage(msg) {
	...
	exports.default = LifecycleWatcher;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactMixin = __webpack_require__(167);
	...
	var SimpleComponent = function (_Component) {
	  ...
	  function SimpleComponent() {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SimpleComponent).call(this));

	    _this.state = { selectedValue: '' };
	    _reactMixin2.default.onClass(SimpleComponent, _lifecycleWatcher2.default);
	    return _this;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BookListContainer = function (_Component) {
	  ...
	  function BookListContainer() {
	    ...
	    _this.state = { books: [], selectedValue: '' };
	    _this.color = 'blue';
	    _reactMixin2.default.onClass(BookListContainer, _lifecycleWatcher2.default);
	    return _this;
	  }
	  ...
	  _createClass(BookListContainer, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(BookListPresentation, { books: this.state.books })
	      );
	    }
	  }]);
	...
	var BookListPresentation = function (_Component2) {
	  _inherits(BookListPresentation, _Component2);

	  function BookListPresentation() {
	    _classCallCheck(this, BookListPresentation);

	    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(BookListPresentation).call(this));

	    _this2.color = 'green';
	    _reactMixin2.default.onClass(BookListPresentation, _lifecycleWatcher2.default);
	    return _this2;
	  }

	  _createClass(BookListPresentation, [{
	    key: 'render',
	    value: function render() {
	      console.log('%c render', 'color: ' + this.color);
